...
public class Java_JDBC {  
    ...
    public static Connection getConnectionWithSqlJdbc() throws Exception 
    {
        ...
        String port ="1433";
        String IP = "127.0.0.1";
        String ServerName ="TOANBACH";
        String DBName ="School";
        String driverClass = "com.microsoft.sqlserver.jdbc.SQLServerDriver";
        
        String dbURL = "jdbc:sqlserver://TOANBACH;databaseName=School;encrypt=false;trustServerCertificate=false;loginTimeout=30"; 
    ...
    {   
        ...
        try{ 
            ...
            while(rs.next()){
                System.out.println (rs.getInt(1) + " Ten SV: " + rs.getString("Name"));
            }
